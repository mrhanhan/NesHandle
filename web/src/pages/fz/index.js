        ...
        <div style={{marginTop: '50px'}}>
            <div style={{display: "flex", alignItems: 'end', position: 'absolute', bottom: '30px', width: '100%'}}>
                ...
                <div style={{flex: "1", textAlign: "center"}}>
                    ...
                    <BtnKey type={"sm"} btnKey={KEYMAPS[keymapIndex].keymap.com}> 投币 </BtnKey>
                </div>
                <div style={{display: "inline-block"}}>
                    <BtnKey type={"attach"} btnKey={KEYMAPS[keymapIndex].keymap.Z}>R</BtnKey>&nbsp;
                    ...
                    <BtnKey type={"attach"} btnKey={KEYMAPS[keymapIndex].keymap.C}>L</BtnKey>&nbsp;
